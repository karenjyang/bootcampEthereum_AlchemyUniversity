...
/*
(base) karenjyang@Karens-MBP MintGovernance-main % npx hardhat test
Compiled 30 Solidity files successfully


  MyGovernor
    ✔ should provide the owner with a starting balance (284ms)
    after proposing
      ✔ should set the initial state of the proposal (106ms)
      after voting
        ✔ should have set the vote (97ms)
        ✔ should allow executing the proposal
